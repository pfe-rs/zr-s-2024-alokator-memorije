...
class Element: #klasa Element, koja se sastoji samo od liste brojeva koji predstavljaju element koji treba dodati u listu
...
class Alokator: #klasa Alokator, prosledjuje joj se broj elemenata liste koja predstavlja memoriju, kao i string u kom se govori koji algoritam treba da se primeni
    def __init__(self, n, algorithm):
        self.al = [random.randint(0, 1) for _ in range (n)] #formiranje liste koja je memorija, gde 1 predstavlja mesto koje je zauzeto, formira se random od 0 i 1
        self.l = [0] * n #iste je duzine kao prethodna lista, i za svaki deo memorije pokazuje sta se tu nalazi, na pocetku je formirana samo od 0 pa se posle dodaju elementi
        self.algorithm = algorithm
        self.lista = []

    def getAllocatedList(self):
        return self.al #vraca listu koja predstavlja memoriju

    def getList(self):
        return self.l #vraca listu koja govori sta se nalazi na kom mestu u memoriji
    
    def getElement(self, ind):
        poc = self.lista[ind][0]
        kraj = self.lista[ind][0] + self.lista[ind][1]
        return self.l[poc:kraj]
...
class Algoritam: #klasa algoritam u kojoj se nalazi abstraktna metoda find koja se implementira u okviru FirstFind i BestFind klasa
    def __init__(self):
        None
...
class FirstFit(Algoritam): #klasa FirstFit, dete klase Algoritam
    def __init__(self):
        super().__init__()
...
class BestFit(Algoritam): #klasa FirstFit, dete klase Algoritam
    def __init__(self):
        super().__init__()
